...
const useTokenBalance = (tokenName, userAddr, ethereum) => {
    ...
    useEffect(
        () => {
            getUserBalance(tokenName, userAddr)
                .then((result) => {
        ...
        <Card>
            ...
            <CardContent>
                <div style={{flex: 1}}>
                    ...
                    <Value
                        value={!!account ? getBalanceNumber(balance) : 'Wallet Not Connected'}
                        decimals={4}
                    />
                </div>
            </CardContent>
            <CardContent>
                <div style={{flex: 1}}>
                    <Label text="TEST DAI"/>
                    <Value
                        value={!!account ? getBalanceNumber(DAIBalance) : 'Wallet Not Connected'}
                        decimals={4}
                    />
                </div>
            </CardContent>
            <CardContent>
                <div style={{flex: 1}}>
                    ...
                    <Value
                        value={!!account ? getBalanceNumber(USDTBalance, 6) : 'Wallet Not Connected'}
                        decimals={4}
                    />
                </div>
            </CardContent>
            <CardContent>
                <div style={{flex: 1}}>
                    ...
                    <Value
                        value={!!account ? getBalanceNumber(USDCBalance, 6) : 'Wallet Not Connected'}
                        decimals={4}
                    />
                </div>
            </CardContent>
